...
public class ProgressCircle2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mOval, -startAngle + currentAngleGap, (mSweepAngle * 128) - currentAngleGap, false,
                progressPaint);

        mOval.set(strokeWidth / 2, strokeWidth + 2, getWidth() - (strokeWidth / 2), getWidth() - (strokeWidth / 2));
        canvas.drawArc(mOval, mSweepAngle * 128 - startAngle + currentAngleGap, 128 - (mSweepAngle * 128) - currentAngleGap, false,
                incompletePaint);

        drawText(canvas, textPaint, String.valueOf((int) (mSweepAngle * 128)), percentagePaint);
    ...
    public void startAnimation() {
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ProgressCircle2.this.mSweepAngle = (Float) valueAnimator.getAnimatedValue();
                ProgressCircle2.this.invalidate();
            }
        });
