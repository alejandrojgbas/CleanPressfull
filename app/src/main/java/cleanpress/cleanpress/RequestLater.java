...
public class RequestLater extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickAddressLay = (LinearLayout) findViewById(R.id.pickAddressLay);
        pickHourLay = (LinearLayout) findViewById(R.id.pickHourLay);
        delivAddressLay = (LinearLayout) findViewById(R.id.delivAddressLay);
        delivHourLay = (LinearLayout) findViewById(R.id.delivHourLay);
        placeOrder = (Button) findViewById(R.id.buttonPlace);

        scrollView = (ScrollView) findViewById(R.id.scrollLater);
        ...
        titlePick = (TextView) findViewById(R.id.titlePick);
        spinnerPickText = (TextView) findViewById(R.id.spinnerPickText);
        pickCurrentLoc = (CheckBox) findViewById(R.id.pickCurrent);
        pickAddress = (EditText) findViewById(R.id.pick_address);
        pickUnit = (EditText) findViewById(R.id.pick_unit);
        pickZip = (EditText) findViewById(R.id.pick_zip);
        pickSpecial = (EditText) findViewById(R.id.pick_special);
        pickLocation = (Spinner) findViewById(R.id.pickSelect_loc);
        ...
        pickTimeTitle = (TextView) findViewById(R.id.pickTimeTitle);
        pickDate = (TextView) findViewById(R.id.pickDate);
        pickDay = (TextView) findViewById(R.id.pickDay);
        pickHour = (Spinner) findViewById(R.id.pickHour);
        sameAddress = (CheckBox) findViewById(R.id.useSameAddress);
        ...
        delivAddTitle = (TextView) findViewById(R.id.titleDelivery);
        spinnerDelivText = (TextView) findViewById(R.id.delivSpinnerText);
        delivCurrentLoc = (CheckBox) findViewById(R.id.delivCurrent);
        delivAddress = (EditText) findViewById(R.id.deliv_address);
        delivUnit = (EditText) findViewById(R.id.deliv_unit);
        delivZip = (EditText) findViewById(R.id.deliv_zip);
        delivSpecial = (EditText) findViewById(R.id.deliv_special);
        delivLocation = (Spinner) findViewById(R.id.delivSelect_loc);
        ...
        delivHour = (Spinner) findViewById(R.id.delivHour);
        delivTimeTitle = (TextView) findViewById(R.id.delivHourTitle);
        delivDate = (TextView) findViewById(R.id.delivDate);
        delivDay = (TextView) findViewById(R.id.delivDay);
    ...
    public void currentLocationPick (View view) {
    ...
    public void currentLocationDeliv (View view) {
    ...
    public void useSameAddress (View view){
        if (sameAddress.isChecked()){
    ...
    public void placeOrderTimed (View view){
    ...
    private void submitOrder (){
        ...
        orderNumber.getFirstInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject parseObject, ParseException e) {
                if (e==null){
                    final long orderNumber = parseObject.getLong("OrderNumber") + 1;

                                ParseObject SubmitOrder = new ParseObject("Order");

                                SubmitOrder.put("DeliveryAddress",delivAddress.getText().toString());
                                SubmitOrder.put("DeliveryUnit",delivUnit.getText().toString());
                                SubmitOrder.put("DeliverySpecialNotes",delivSpecial.getText().toString());
                                SubmitOrder.put("DeliveryZipcode",delivZip.getText().toString());
                                SubmitOrder.put("Deliveryhour",delivHour.getSelectedItem().toString());
                                SubmitOrder.put("Dropoffdate",delivDate.getText().toString());

                                SubmitOrder.put("PickupAddress",pickAddress.getText().toString());
                                SubmitOrder.put("PickupUnit",pickUnit.getText().toString());
                                SubmitOrder.put("PickupSpecialNotes",pickSpecial.getText().toString());
                                SubmitOrder.put("PickupZipcode",pickZip.getText().toString());
                                SubmitOrder.put("PickHour",pickHour.getSelectedItem().toString());
                                SubmitOrder.put("Pickupdate",pickDate.getText().toString());

                                SubmitOrder.put("OrderNumber",orderNumber);
                                SubmitOrder.put("Paid",false);
                                SubmitOrder.put("Verify",false);
                                SubmitOrder.put("Done",false);
                                SubmitOrder.put("Todo",false);
                                SubmitOrder.put("WashFold",false);
                                SubmitOrder.put("DryCleaning",false);

                                SubmitOrder.saveInBackground(new SaveCallback() {
                                    @Override
                                    public void done(ParseException e) {
                                        if (e==null){
                                            startActivity(new Intent(RequestLater.this,Dashboard.class));
